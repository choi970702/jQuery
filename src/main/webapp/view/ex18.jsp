...
<script type="text/javascript">
	$(function()
	{
		...
		$("#btn1").click(function() 
		{
			...
			$("div").addClass("f_blue, bg_tomato, f_bold");
		});
		$("#btn2").click(function() 
		{
			$("h1, h2").removeClass("f_blue");
			$("p").removeClass("bg_tomato");
			$("div").removeClass("f_blue, bg_tomato, f_bold");
		});
		$("#btn3").click(function() 
		{
			$("h1, h2").toggleClass("f_blue");
			$("p").toggleClass("bg_tomato");
			$("div").toggleClass("f_blue, bg_tomato, f_bold");
		});
		$("#btn4").click(function() 
		{
			$("h1, h2").css("background-color","skyblue");
			$("p").css("font-size", "24px").css("color", "red");
			$("div").css({"background-color":"yellow", "width":"200px","hegiht":"200px"});
		});
	});
</script>
<script type="text/javascript">
