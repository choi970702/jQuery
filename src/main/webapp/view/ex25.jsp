...
<script type="text/javascript">
	$(function()
	{
		...
		var total = $("li").length; 			// li의 개수
		var li_width = $("li:first").width(); 	// li하나의 너비
		
		// li 태그중 index값이 3보다 작아지면 li태그 복사하여 붙여 넣자
...
<body>
	...
	<div id="banner_warp">
		...
		<p id="footer">
			<a href="#" id="prev"><img src="../images/img7.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="#" id="next"><img src="../images/img8.png"></a>
		</p>
	</div>
</body>
</html>